...
public final class Calculus {
	...
	public static class Definition {
		...
		public IExpression apply(final IExpression function,
			...
			return def(vars(this.variables),
					Calculus.apply(function, arguments));
		}
		...
		public IExpression var(final String variableName) {
			return def(vars(this.variables), Calculus.var(variableName));
		}
		...
		public IExpression con(final String constantName) {
			return def(vars(this.variables), Calculus.con(constantName));
		}
