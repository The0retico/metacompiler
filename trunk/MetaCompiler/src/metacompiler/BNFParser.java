...
class BNFParser {
	 ...
	 * @throws IOException
	 */
	private Iterable<ImmutableList<String>> parseAlternatives()
			throws IOException {
		final ImmutableList.Builder<ImmutableList<String>> result = ImmutableList
				.builder();
		result.add(parseProduction());
	...
	private ImmutableListMultimap<String, ImmutableList<String>> parseRule()
			throws ParserException, IOException {
		Preconditions.checkState(lexer.ttype != StreamTokenizer.TT_EOF);
		final ImmutableListMultimap.Builder<String, ImmutableList<String>> alternatives = ImmutableListMultimap
				.builder();
