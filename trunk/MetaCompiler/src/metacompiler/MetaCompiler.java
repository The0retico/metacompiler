...
public final class MetaCompiler {
	...
	public static ImmutableList<Entry<String, Entry<ImmutableList<String>, String>>> compile(
		...
		// final ImmutableList<Entry<String, ImmutableList<String>>> bnfAST =
		// parser.analyze(grammarDefinition);
		...
		final ImmutableList<Entry<String, Entry<ImmutableList<String>, String>>> programAST = parser
				.analyze(program);
		return programAST;
	}
